...
class _AnalyticsViewState extends State<AnalyticsView> {
  ...
  @override
  Widget build(BuildContext context) => Consumer<StudySessionProvider>(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  s.averagePerDay(_formatDuration(
                                      (weeklyStats?.totalSeconds ?? 0) ~/ 7)),
                                ),
                                const SizedBox(height: 8),
                                Text(
                                      ...
                                      builder: (context, constraints) {
                                        ...
                                        return Row(
                                          ...
                                          children: List.generate(7, (index) {
                                            final dailySeconds =
                                                weeklyStats.dailySeconds[index];
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (paginatedSessions.isEmpty)
                                  ...
                                  ...paginatedSessions.map((session) => Padding(
                                        padding:
